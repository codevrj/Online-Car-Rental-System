...
<title>Online Car Rental Portal</title>
<!--Bootstrap -->
...
<div class="swiper-container mySwiper">
    <div class="swiper-wrapper">
            ...
            <div class="swiper-slide"><img src="img/a.jpg" alt=""></div>
            <div class="swiper-slide"><img src="img/b.jpg" alt=""></div>
            <div class="swiper-slide"><img src="img/c.jpg" alt=""></div>
            <div class="swiper-slide"><img src="img/d.jpg" alt=""></div>
            <div class="swiper-slide"><img src="img/e.jpg" alt=""></div>
            <div class="swiper-slide"><img src="img/f.jpg" alt=""></div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>We are ranked number one by Smartertravel as The best car rental booking site in 2020 and provides excellent pricing on a wide range of vehicles.You can be sure that the car you reserved will be the car you drive at the price you were quoted. Whether you are looking for a standard economy or compact car rental or something a little bigger like an SUV, we have plenty of options to choose from. We also have convertible, luxury and premium options if you want a more upscale rental. You can easily compare prices for each car, for mobile be sure to use our filters in the list view in order to pull the best results for your individual needs.</p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Our Vehicles</a></li>
        </ul>
      </div>
...
{  ?>
        ...
        <div class="testimonial-m">
          <div class="testimonial-img"> <img src="assets/images/cat_profile.png" alt="" /> </div>
